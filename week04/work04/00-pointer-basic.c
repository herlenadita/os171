...
void main(void){
	...
	*ptrptr0, ptrptr0, &ptrptr0);
	...
	printf("ultimate_pointer0: val=%p, adr=%p, ultimate_pointer*=%p, ultimate_pointer**=%p, ultimate_pointer***=%c\n", ultimate_pointer0,
	&ultimate_pointer0, *ultimate_pointer0, **ultimate_pointer0, ***ultimate_pointer0);
	printf("ultimate_pointer1: val=%p, adr=%p, ultimate_pointer1*=%p, ultimate_pointer1**=%p, ultimate_pointer1***=%c\n", ultimate_pointer1,
        &ultimate_pointer1, *ultimate_pointer1, **ultimate_pointer1, ***ultimate_pointer1);
	printf("ultimate_pointer2: val=%p, adr=%p, ultimate_pointer2*=%p, ultimate_pointer2**=%p, ultimate_pointer2***=%c\n", ultimate_pointer2,
        &ultimate_pointer2, *ultimate_pointer2, **ultimate_pointer2, ***ultimate_pointer2);
	printf("ultimate_pointer3: val=%p, adr=%p, ultimate_pointer3*=%p, ultimate_pointer3**=%p, ultimate_pointer3***=%c\n", ultimate_pointer3,
        &ultimate_pointer3, *ultimate_pointer3, **ultimate_pointer3, ***ultimate_pointer3);
